...
const LoginV2 = ({ mode }: { mode: Mode }) => {
  ...
  const darkIllustration = '/images/illustrations/auth/chat.png'
      ...
      <div className='flex justify-center items-center bs-full bg-backgroundPaper !min-is-full p-6 md:!min-is-[unset] md:p-12 md:is-[480px]'>
        ...
        <div className='flex flex-col gap-5 is-full sm:is-auto md:is-full sm:max-is-[400px] md:max-is-[unset]'>
          <div>
            ...
            <Typography className='mbs-1'>Пожалуйста, войдите в систему и начните свое обшение.</Typography>
          </div>
          <form
            noValidate
            autoComplete='off'
          ...
          >
            <TextField autoFocus fullWidth label='Электронная почта' />
            <TextField
              fullWidth
              label='Пароль'
              type={isPasswordShown ? 'text' : 'Пароль'}
              slotProps={{
                input: {
                  endAdornment: (
            ...
            <div className='flex justify-center items-center flex-wrap gap-2'>
              <Typography>Впервые на нашей платформе?</Typography>
